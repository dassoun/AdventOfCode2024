...
//		BigInteger newRegisterA = BigInteger.ZERO;
		BigInteger newRegisterA = BigInteger.valueOf(55593699);
		
		while (output.equals("") || output.length() != program.length() || !output.equals(program.substring(0, Math.min(output.length(), program.length())))) {
			...
			while ((i + 1) < opcodeArray.length && running) {
				...
				switch (opcode) {
					...
					case "5":
						...
						if (!output.equals(program.substring(0, output.length()))) {
							running = false;
						}
...
//				System.out.println("==================");
			...
			newRegisterA = newRegisterA.add(BigInteger.valueOf(1));
			
//			System.out.println(output.equals(""));
//			System.out.println(output.length());
//			System.out.println(program.length());
//			System.out.println(output);
//			System.out.println(program.substring(0, Math.min(output.length(), program.length())));
		}
